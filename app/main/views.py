...
def index():
    ...
    return render_template('index.html', title = 'BlogSpot - Home', cuisine = cuisine, voyage = voyage, health = health, empower = empower)
...
def new_blog():
    ...
    if form.validate_on_submit():
        ...
        for email in subscriber:
            mail_message("New Blog Post from BlogSpot! ","email/postnotification",email.email,subscriber=subscriber)
